...
let Projects = ({ Component, pageProps }) => {
    ...
    return (
        <div id="projects" className="flex-column w-10/12 rounded-lg justify-center align-center px-4 mt-[200px] bg-slate-900 h-auto">
            <div id = "projects-header" className="w-full text-5xl font-light p-6 text-white " >
                <h1 className = "md:text-center p-3 pb-6">Projects</h1>
                <hr></hr>
            </div>
            <div id = "projects-body" className = "grid grid-cols-1 2xl:grid-cols-2  w-full text-3xl mt-8 text-white" >
